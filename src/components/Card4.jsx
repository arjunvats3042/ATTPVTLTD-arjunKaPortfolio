              ...
              >
                ...
                <g id="SVGRepo_iconCarrier">
                  ...
                  <path
                    fill-rule="evenodd"
                    clip-rule="evenodd"
                    d="M8 16C12.4183 16 16 12.4183 16 8C16 3.58172 12.4183 0 8 0C3.58172 0 0 3.58172 0 8C0 12.4183 3.58172 16 8 16ZM9 3V8H6.52192L7.47855 3.45601L5.52145 3.04399L4.5 7.89588V10H9V13H11V3H9Z"
                    fill="#000000"
                  ></path>{" "}
                </g>
              </svg>
...
const StyledWrapper = styled.div`
  ...
  .content .text {
    display: block;
    color: rgba(0, 78, 137, 0.7647058824); /* Blue */
