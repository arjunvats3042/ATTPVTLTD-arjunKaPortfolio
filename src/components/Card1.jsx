      ...
      <div className="parent">
        <div className="card">
              ...
              >
                ...
                <g id="SVGRepo_iconCarrier">
                  ...
                  <path
                    fill-rule="evenodd"
                    clip-rule="evenodd"
                    d="M8 16C12.4183 16 16 12.4183 16 8C16 3.58172 12.4183 0 8 0C3.58172 0 0 3.58172 0 8C0 12.4183 3.58172 16 8 16ZM7.36608 3L4.48688 3.78524L5.01312 5.71476L7 5.17289V11H5V13H11V11H9V3H7.36608Z"
                    fill="#000000"
                  ></path>{" "}
                </g>
              </svg>
          ...
          <div className="content">
            <span className="title">#Samvaad</span>
            <span className="text">
              A real-time chat app built with React, featuring seamless
              messaging and user authentication.
            </span>
          </div>
          <div className="bottom">
            <div className="social-buttons-container">
              <a
                href="https://github.com/arjunvats3042/fullstack_chat_app"
                target="_blank"
              ...
              <a
                href="https://samvaad-9cvj.onrender.com"
                target="_blank"
                rel="noopener noreferrer"
                className="social-button .social-button2"
              >
