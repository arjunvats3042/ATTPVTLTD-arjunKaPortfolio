      ...
      <div className="parent">
        <div className="card">
          ...
          <div className="content">
            <span className="title">AKTU Ghar</span>
            <span className="text">
              All study material, courses and notes at one place. [Working on
              it...]
            </span>
          </div>
