...
const Achievement2 = () => {
  return (
    <StyledWrapper>
      <div className="card">
        <span className="text">CODECHEF</span>
      </div>
    </StyledWrapper>
  );
};
...
const StyledWrapper = styled.div`
  .text {
    color: #87ceeb; /* Light Blue text color */
  ...
  .card:hover:after {
    color: black;
    content: "1625+ rating and 3-star coder on CodeChef, with global ranks of 280 and 242 in contests.";
    font-size: 15px;
    font-weight: medium;
    padding: 10px;
