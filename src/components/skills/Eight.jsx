...
import {faNodeJs} from "@fortawesome/free-brands-svg-icons"; // Import the faNodeJs icon

const Eight = () => {
  return (
    <StyledWrapper>
      <div className="gas kr">
        <FontAwesomeIcon className="symbol" icon={faNodeJs} size="2x" />
        {/* Use the faNodeJs icon */}
        <p className="font-chakra font-bold text-xl">Node.js</p>
      </div>
    </StyledWrapper>
  );
};
...
const StyledWrapper = styled.div`
  ...
  .gas.kr {
    --color: #00ff00; /* Green color for Node.js */
    filter: saturate(200%);
  }
